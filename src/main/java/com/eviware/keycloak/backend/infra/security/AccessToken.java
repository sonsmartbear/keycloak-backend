package com.eviware.keycloak.backend.infra.security;
...
import com.eviware.keycloak.backend.infra.security.config.SecurityConfig;
...
public record AccessToken(String value) {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        return StreamSupport.stream(
                        payloadAsJson.getAsJsonObject(SecurityConfig.RESOURCE_ACCESS).getAsJsonArray("roles").spliterator(), false)
